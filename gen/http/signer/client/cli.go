...
func BuildCreateCredentialPayload(signerCreateCredentialBody string, signerCreateCredentialXOrigin string, signerCreateCredentialXTenantid string, signerCreateCredentialXGroupid string) (*signer.CreateCredentialRequest, error) {
	var err error
	...
	{
		xTenantid = signerCreateCredentialXTenantid
	}
	var xGroupid string
	{
		if signerCreateCredentialXGroupid != "" {
			xGroupid = signerCreateCredentialXGroupid
		}
	}
