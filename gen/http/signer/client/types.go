...
type CredentialProofRequestBody struct {
	...
	// tenantid
	XTenantid string `form:"x-tenantid" json:"x-tenantid" xml:"x-tenantid"`
	// Tenant Group
	XGroupid string `form:"x-groupid" json:"x-groupid" xml:"x-groupid"`
	// Holder Binding
	Holder *string `form:"holder,omitempty" json:"holder,omitempty" xml:"holder,omitempty"`
	// Statuslist. Ignored when status=false
	Statuslisttype string `form:"statuslisttype" json:"statuslisttype" xml:"statuslisttype"`
	// Origin of call
...
func NewCredentialProofRequestBody(p *signer.CredentialProofRequest) *CredentialProofRequestBody {
	...
	{
		var zero string
		if body.XGroupid == zero {
			body.XGroupid = ""
		}
	}
	{
		var zero string
		if body.Statuslisttype == zero {
			body.Statuslisttype = "StatusList2021"
		}
	}
	return body
}
