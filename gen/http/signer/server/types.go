...
type CredentialProofRequestBody struct {
	...
	// Statuslist. Ignored when status=false
	Statuslisttype *string `form:"statuslisttype,omitempty" json:"statuslisttype,omitempty" xml:"statuslisttype,omitempty"`
	// Origin of call
...
func NewCredentialProofRequest(body *CredentialProofRequestBody) *signer.CredentialProofRequest {
	...
	if body.XGroupid != nil {
		v.XGroupid = *body.XGroupid
	}
	if body.Statuslisttype != nil {
		v.Statuslisttype = *body.Statuslisttype
	}
	if body.Group == nil {
		v.Group = ""
	}
	...
	if body.Statuslisttype == nil {
		v.Statuslisttype = "StatusList2021"
	}
...
// payload.
func NewCreateCredentialRequest(body *CreateCredentialRequestBody, xOrigin string, xTenantid string, xGroupid string) *signer.CreateCredentialRequest {
...
func ValidateCredentialProofRequestBody(body *CredentialProofRequestBody) (err error) {
	...
	if body.XTenantid == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("x-tenantid", "body"))
	}
	if body.XDid == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("x-did", "body"))
	}
	if body.XOrigin == nil {
