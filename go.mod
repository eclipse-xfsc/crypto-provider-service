module github.com/eclipse-xfsc/crypto-provider-service/v2
...
require (
	...
	github.com/eclipse-xfsc/train-trusted-content-resolver/clients/go v1.0.0
...
require (
	...
	github.com/eclipse-xfsc/oid4-vci-vp-library v1.8.1 // indirect
